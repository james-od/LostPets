...
public class notify extends Service {
    ...
    public void onCreate() {
        ...
        //Toast.makeText(this, sharedPrefs.getString("notification_period", "Weekly"), Toast.LENGTH_LONG).show();
        final String notificationPeriod = sharedPrefs.getString("notification_period", null);
        handler = new Handler();
        runnable = new Runnable() {
            public void run() {
                ...
                Long period;
                try {
                    period = TimeUnit.DAYS.toMillis(Integer.parseInt(notificationPeriod));
                } catch (NumberFormatException e) {
                    System.out.println("exception number format notification call");
    ...
    public void getNotified(){
        SharedPreferences sharedPrefs = PreferenceManager.getDefaultSharedPreferences(this);
        String notificationRadius = sharedPrefs.getString("notification_radius", null);
